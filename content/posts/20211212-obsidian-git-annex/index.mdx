...
After this is configure, if you make and commit a change to your repository on one system, short after you can confirm with `git log` that your changes propagated to your other Macs:
